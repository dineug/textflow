...
import * as editorStyles from '@/components/editor-composer/EditorComposer.css';
...
ImagePlugin.displayName = 'extensionImage.Plugin';
...
function canDropImage(event: DragEvent): boolean {
  ...
  return !!(
    ...
    !target.closest(`code, .${themeStyles.image}`) &&
    target.parentElement &&
    target.parentElement.closest(`.${editorStyles.contentEditable}`)
  );
}
